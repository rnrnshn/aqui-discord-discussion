...
class DiscussionEngine:
    ...
    def _build_prompt(self, session: Session, index: int) -> str:
        ...
        return (
            ...
            "- Speak only as your current Hermes identity and from your own perspective.\n"
            "- If the topic assigns named roles, perform only the role assigned to you.\n"
            "- Never simulate, predict, quote, summarize, label, or write another participant's response.\n"
            "- Do not include headings or sections attributed to another participant.\n"
            "- Leave validation, disagreement, counterarguments, and future roles to later turns.\n"
            "- If your assigned role is unclear, provide one independent perspective only.\n"
